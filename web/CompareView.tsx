  ...
  return <>
    <div className="visual-tools">
      ...
      {visual && <><div className="visual-controls"><label className="checkbox-label"><input type="checkbox" checked={show} onChange={event => setShow(event.target.checked)} /> Evidenzia le modifiche</label>
        ...
        {dimensionsChanged && <p className="dimension-change">Dimensioni diverse: {visual.left.width} × {visual.left.height} → {visual.right.width} × {visual.right.height} pixel. Anche una piccola variazione delle dimensioni può aver fatto scattare il salvataggio.</p>}
