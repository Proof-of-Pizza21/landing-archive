...
Landing Archive 0.1.6 è un'anteprima per mini PC Intel/AMD a 64 bit
(`linux/amd64`), con umbrelOS 1.7.4 come ambiente di destinazione. Le prove
Docker su Linux amd64 sono [riuscite](https://github.com/Proof-of-Pizza21/landing-archive/actions/runs/34747984632), comprese acquisizione reale,
...
L'immagine pubblica `ghcr.io/proof-of-pizza21/landing-archive:0.1.6` è stata
...
mantenendo l’installazione esistente. La versione 0.1.6 conserva lo stesso
...
Riapri l’interfaccia e verifica che nella barra laterale compaia **0.1.6**.
Apri una pagina e scegli **Pagina offline** per consultare le copie già archiviate.
Per una nuova acquisizione, apri un sito e premi **Controlla e scarica ora**; se un tentativo è già attivo,
...
Per il codice 0.1.6 sono necessari Node.js 24.20.0 o successivo della linea 24, npm e le dipendenze
...
`sha256:0236c013c031198f74089db38f9a80b9473b9d782683d4ba1b1010afadd9f359`. Il download anonimo dal registro è stato verificato.
...
Le prove automatiche e Docker Linux amd64 sono completate. L'immagine 0.1.6 è
...
Il [collaudo Docker Linux amd64](https://github.com/Proof-of-Pizza21/landing-archive/actions/runs/34747984632) ha poi avviato i due container con
