...
Dalla 0.1.5 la scheda **Pagina offline** apre l’HTML direttamente nell’app.
...
una copia successiva viene indicata esplicitamente. [Dettagli e limiti](RELEASE-0.1.5.md).
